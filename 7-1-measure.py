...
try:
    ...
    with open("data.txt", "w") as outfile:                 #сохранение значения data в data.txt
        outfile.write("\n".join(meas_data_str))
    ...
    with open("nsettings.txt", "w") as f:       #сохранение значений средней частоты дискретизации и шага квантования АЦП в nsettings.txt
        f.write(frequency)
        f.write("\n")
        f.write(step)
